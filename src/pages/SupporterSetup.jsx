...
export default function SupporterSetup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showToast('Supporter profile saved successfully.')

      navigate('/supporter/dashboard', {
        replace: true,
      })
    } catch (error) {
      console.error('SUPPORTER SETUP ERROR:', error)

      showToast(
        error?.message ||
          'Unable to complete supporter setup.',
        'error',
      )
    } finally {
      setLoading(false)
  ...
  return (
    <div className="min-h-screen bg-bg px-6 py-12">
      <form
        ...
        className="max-w-xl mx-auto flex flex-col gap-6 animate-fadeIn"
      >
        {/* Header */}
        <div className="text-center mb-2">
          ...
          <p className="text-ink-500">
            Next, you'll connect to the person you're supporting.
          </p>
        </div>
        ...
        <Card>
          <div className="flex items-center gap-3 mb-5">
            <div className="w-9 h-9 rounded-lg bg-teal-50 text-teal-600 flex items-center justify-center font-display font-semibold text-sm">
              1
            </div>
              ...
              <label
                ...
                className={[
                  ...
                  helpStyle === style
                    ...
                    : 'border-ink-100 hover:border-teal-200',
                ].join(' ')}
              >
                <input
                  type="radio"
          ...
          <div className="flex items-center justify-between">
            <div>
              <p className="font-medium text-ink-800 text-sm">
                Updates about shared information
              </p>

              <p className="text-xs text-ink-500">
                Only what's explicitly shared, when it changes.
              </p>
            </div>
